export const prodServerUrl = "https://api.scu-schedule-helper.me";
...
export const prodNameMappingsEndpoint = `${prodServerUrl}/name_mappings`;
...
export const prodChatEndpoint = `${prodServerUrl}/chat`;